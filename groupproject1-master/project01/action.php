...
<!-- Aside -->
                <aside class="o-grid__cell">
							...
							<!--From: https://en.wikipedia.org/wiki/Call_of_Duty_(video_game)  -->
				             <p><em>Call of Duty</em></p>
							 
							  <div class="c-card c-card--higher c-card--primary">
							 <div class="c-card__content c-card__content--divider">
							 	Call of Duty Black Ops. <a class="c-link"  class="c-link" href="http://getintopc.com/games/shooting-games/call-of-duty-black-ops-2-download-free-repack-single-link/"> Source</a></div>
							 <figure>					 
